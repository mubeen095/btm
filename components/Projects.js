        ...
        <Container>
          <div class="md:w-2/3 lg:w-1/2">
            ...
            <h2 class="my-8 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
              A technology-first approach to get you a high paying job
            </h2>
            <p class="text-gray-600 dark:text-gray-300">
            At Skill Garage, your goals are our ambition. As the premier EdTech platform, 
            we offer comprehensive bundle courses with certifications that provide lifetime
            access to learning and growth. Our expertly designed programs empower you to achieve your full potential, 
            ensuring you have the skills and knowledge to succeed in today's competitive landscape.
            </p>
          </div>
          <div class="mt-16 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
            ...
            <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
              <div class="relative space-y-8 py-12 p-8">
                ...
                <div class="space-y-2">
                  <h5 class="text-xl font-semibold text-gray-700 dark:text-white transition group-hover:text-secondary">
                    How do we lookmon your resume 
                  </h5>
                  <p class="text-gray-600 dark:text-gray-300">
                  We enhance your resume with industry-recognized certifications and expert knowledge,
